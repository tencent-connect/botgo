...
func Test_ChannelRolesPermissions(t *testing.T) {
	t.Run("update roles Permissions", func(t *testing.T) {
	...
	t.Run("get roles Permissions", func(t *testing.T) {
...
func Test_ChannelMembersPermissions(t *testing.T) {
	t.Run("update members Permissions", func(t *testing.T) {
		updatePermissions := &dto.UpdateChannelPermissions{
			Add: "5",
		}
	...
	t.Run("get members Permissions", func(t *testing.T) {
